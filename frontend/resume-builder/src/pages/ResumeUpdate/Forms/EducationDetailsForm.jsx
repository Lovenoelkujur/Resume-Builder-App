  ...
  return (
    <div className='px-5 pt-5'>
        ...
        <div className='mt-4 flex flex-col gap-4 mb-3'>
            {educationInfo.map((education, index) => (
                ...
                >
                    ...
                    {educationInfo.length > 1 && (
                        <button
                            type='button'
                            className='absolute top-3 right-3 text-xs text-red-600 hover:underline cursor-pointer'
            ...
            <button
                type='button'
                className='self-start flex items-center gap-2 px-4 py-2 rounded bg-purple-100 text-purple-800 text-sm font-semibold hover:bg-purple-200 cursor-pointer'
